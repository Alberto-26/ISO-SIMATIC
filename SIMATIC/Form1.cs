...
namespace SIMATIC
{
    public partial class Form1 : Form
    {
        ...
        {
            toolTip1.SetToolTip(this.iconCerrar, "Salir");
            toolTip1.SetToolTip(this.iconMaxi, "Maximizar");
            toolTip1.SetToolTip(this.iconMini, "Minimizar");
            toolTip1.SetToolTip(this.iconResaurar, "Restaurar");
        }
